...
export const cvUrl =
  'https://drive.google.com/file/d/1WJplJQ1Oa6bXGaYJzaaFJn7hmTOHLAuF/view?usp=sharing';
  ...
  () => (
    <>
      ...
      <div className="flex items-center">
        <RiFileList3Line className="text-blue-700 dark:text-cyan-500" size="1.3rem" />
        &nbsp;
        <CustomLink name="Résumé" href={cvUrl} />
      </div>
    </>
  ),
];
